...
<head>
    ...
    <!-- Title -->
    <title>Login - PKM Lakologou</title>
    ...
    <div class="login-wrapper d-flex align-items-center justify-content-center">
        <div class="custom-container">
            <div class="text-center px-4">
                <img width="100" class="login-intro-img" src="{{ asset('/') }}logopuskesmas.png" alt="">
            </div>

            <!-- Register Form -->
            <div class="register-form mt-4">
                <h6 class="mb-3 text-center">Gudang Obat Apps</h6><br>

                @livewire('mobile.auth.login-index')
            </div>
