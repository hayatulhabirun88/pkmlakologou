<div>
    <section id="wrapper" class="login-register login-sidebar"
        style="background-image:url({{ asset('/') }}/backgroundlogin.jpg);">
        <div class="login-box card">
            <div class="card-body">
                <form class="form-horizontal form-material text-center mt-3" id="loginform" wire:submit="login">
                    <img width="100" src="{{ asset('/') }}/logopuskesmas.png" alt="Home" />
                    <h4 class="mt-5"><strong>Sistem Informasi <br> Persediaan Obat <br></strong></h4>
                    <h3 class="text-center m-b-20 "> Puskesmas Lakologou
                    </h3>
